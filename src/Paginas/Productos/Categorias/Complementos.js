...
function Complementos() {
    ...
    useEffect(() => {
        ...
        const hasOtherFilters = filtroSkus || envioGratisActivo || sub1;
        
        setHasActiveFilters(hasPriceFilter || hasOtherFilters);
    }, [filtroSkus, envioGratisActivo, sub1, location.search]);
    ...
    // PRIMERO: Filtrar productos por subcategoría (desde la URL)
    ...
    const productosConEnvios = useMemo(() => {
        let resultados = productosPorSubcategoria;
        ...
        return resultados;
    }, [productosPorSubcategoria, envioGratisActivo, filtroSkus]);
    ...
    useEffect(() => {
        resetPage();
        scrollToTop();
    }, [sub1, envioGratisActivo, filtroSkus, orden, location.search]);
