...
//                         <ul>
//                             <li>
//                                 <button title='Colchones | Dormihogar' className='menu-cat-link'>
//                                     <a href='/productos/colchones/' className='d-flex-center-center gap-5'>
...
//                                 <div className='menu-cat-submenu'>
//                                     <div className=''>
//                                         <p className='text font-bold color-color-1'>Marcas</p>

//                                         <ul>
//                                             <li>
//                                                 <a href='/productos/colchones/?marca=paraiso' title='' className=''>
//                                                     <p>Paraiso</p>
//                                                     <span class="material-symbols-outlined">keyboard_arrow_right</span>
//                                                 </a>
//                                             </li>
//                                             <li>
//                                                 <a href='/productos/colchones/?marca=kamas' className=''>
//                                                     <p>Kamas</p>
//                                                     <span class="material-symbols-outlined">keyboard_arrow_right</span>
//                                                 </a>
//                                             </li>
...
//                                     <div className=''>
//                                         <p className='text font-bold color-color-1'>Medidas</p>
