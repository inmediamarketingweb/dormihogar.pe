...
// import Garantia from './Componentes/Garantia/Garantia';
...
function PaginaProducto(){
    ...
    // categoryProducts no se usa en el componente, se comenta
    ...
    useEffect(() => {
        ...
        const fetchProducto = async () => {
            ...
            // setCategoryProducts([]); // Comentado porque no se usa
                        ...
                        if (catRes.ok){
                            ...
                            if (Array.isArray(catJson.productos) && catJson.productos.length > 0){
                                if (!cancelled){
                                    ...
                                    // setCategoryProducts(catJson.productos); // Comentado porque no se usa
                        ...
                        <div className='product-page-container'>
                            ...
                            <div className='product-page-target product-page-target-2'>
                                <div className='product-page-top-info'>
                                    ...
                                    <div className='p-pg-stars d-flex-center-center margin-left gap-5'>
                            ...
                            <div className='product-page-target product-page-target-3'>
                                {/* <Envios/> */}
                                <Envios producto={producto} onConfirm={handleEnviosConfirm} />
                            ...
                            <div className='product-page-target product-page-target-4'>
                                <Descripcion 
                                    producto={producto} 
                                    mensajes={mensajes}
                                    ficha={ficha}
