                ...
                <section className='block-container'>
                    <div className='block-content'>
                        ...
                        <div className='d-grid-2-1fr gap-20'>
                            ...
                            <div className='d-flex-column gap-20'>
                                <img src="https://dormihogar.pe/assets/imagenes/paginas/servicio-al-cliente/costos-de-envio-por-zona/costos-de-envio-por-zona.jpg" alt="Envíos a provincia" className='page-banner-img' />
                            </div>
                        </div>
                    </div>
                </section>
